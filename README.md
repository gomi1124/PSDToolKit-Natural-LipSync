...
- 高音域や子音も拾えるスペクトル変化を使い、短すぎる開閉や中間口形状の不自然な全閉じ、連続する類似音での過剰な形状変化を抑えます。
- 3形状以上では密集した発音を中間口でも追従し、最大開口は500ms以上の間隔を空けて約80ms保持します。発話中の250ms以下の短い全閉じも中間口へつなぎ、激しい形状変化を抑えます。
